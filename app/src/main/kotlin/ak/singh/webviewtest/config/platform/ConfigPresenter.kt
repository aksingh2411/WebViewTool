package ak.singh.webviewtest.config.platform

import android.content.Context
import androidx.lifecycle.ViewModel
import ak.singh.webviewtest.R
import ak.singh.webviewtest.config.data.CustomUserAgentRepository
import ak.singh.webviewtest.config.data.RememberUrlRepository
import ak.singh.webviewtest.config.data.RememberUrlRepository.getUrl
import ak.singh.webviewtest.config.data.TrustSslRepository
